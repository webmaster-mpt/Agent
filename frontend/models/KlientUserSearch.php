...
/**
 * KlientUserSearch represents the model behind the search form of `frontend\models\klientuser`.
 */
class KlientUserSearch extends klientuser
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['Fname', 'name', 'Sname', 'address', 'photo', 'telephone', 'rooms', 'udobstva'], 'safe'],
        ];
    }
